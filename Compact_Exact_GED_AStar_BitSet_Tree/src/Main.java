...
public class Main {
    ...
    public static void main(String[] args)
    {
        ...
        //Compact_Exact_GED_AStar_BitSet_Tree exact_GED = new Compact_Exact_GED_AStar_BitSet_Tree(g1,g2);
        Compact_Exact_GED_AStar_BitSet_Tree exact_GED = new Compact_Exact_GED_AStar_BitSet_Tree(g1,g2,amount_RunTime_S);
