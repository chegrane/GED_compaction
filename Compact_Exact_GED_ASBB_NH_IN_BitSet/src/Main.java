...
public class Main {
    ...
    public static void main(String[] args)
    {
        ...
        //Compact_Exact_GED_ASBB_NH_IN_BitSet exact_GED = new Compact_Exact_GED_ASBB_NH_IN_BitSet(g1,g2);
        Compact_Exact_GED_ASBB_NH_IN_BitSet exact_GED = new Compact_Exact_GED_ASBB_NH_IN_BitSet(g1,g2,amount_RunTime_S);
