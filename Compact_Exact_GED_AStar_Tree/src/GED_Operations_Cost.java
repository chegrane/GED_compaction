...
public class GED_Operations_Cost {
    ...
    public static int getVertex_substitution_cost(int idx_fromVertex, int idx_toVertex)
    {
        if(is_Weight)
        {
            if(Graph_Map.get_vertex_from_list_g1(idx_fromVertex).getVertex_weight()==Graph_Map.get_vertex_from_list_g2(idx_toVertex).getVertex_weight()) return 0;
        }

        if(is_Label)
        {
            if(Graph_Map.get_vertex_from_list_g1(idx_fromVertex).getVertexLabel().equals(Graph_Map.get_vertex_from_list_g2(idx_toVertex).getVertexLabel())) return 0;
    ...
    public static int getEdge_substitution_cost(int idx_e1, int idx_e2)
    {

        if(is_Weight) {

            Edge e1 = Graph_Map.get_edge_from_list_g1(idx_e1);
            Edge e2 = Graph_Map.get_edge_from_list_g2(idx_e2);
