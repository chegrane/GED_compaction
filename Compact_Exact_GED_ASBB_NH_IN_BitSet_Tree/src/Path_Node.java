...
public abstract class Path_Node {
    ...
    protected Path_Node NUB_path=null;

    public Path_Node getNUB_path() {
        return NUB_path;
    }
    ...
    protected abstract void compute_h_and_newUpperBound();
    ...
    public abstract boolean add_to_real_path(Edit_Operation edit_operation, int idx_edit_operation_in_map);
    ...
    protected abstract List<Integer> get_Operations_ids_List();
