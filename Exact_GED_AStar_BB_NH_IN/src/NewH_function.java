...
public class NewH_function {
    ...
    public final static Path compute()
    {

        Path father_path=new Path();
        ...
        if(n>0 && m>0)
        {
            ...
            for (int i=0; i<assignment.length; i++)
            {
                ...
                {
                    Edit_Operation vertex_substitution_operation = new Edit_Operation(Graph_Map.list_vertices_g1.get(i1), Graph_Map.list_vertices_g2.get(j1));
                ...
                {
                    Edit_Operation vertex_deletion_operation = new Edit_Operation(Graph_Map.list_vertices_g1.get(i1), null);
                ...
                {
                    Edit_Operation newOp3 = new Edit_Operation(null, Graph_Map.list_vertices_g2.get(j1));
        ...
        else // at this level, either n <=0  or m <=0
        {
            ...
            {
                for(Vertex v: Graph_Map.list_vertices_g1)
                {
                    child_path = new Path(father_path);

                    Edit_Operation vertex_deletion_operation = new Edit_Operation(v, null);
                    child_path.add_to_real_path(vertex_deletion_operation);
            ...
            {
                for(Vertex v: Graph_Map.list_vertices_g2)
                {
                    child_path = new Path(father_path);
