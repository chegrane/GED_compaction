...
public class Compact_Exact_GED_ASBB_NH_IN_Tree {
     ...
     * Default Constructor
     */
    public Compact_Exact_GED_ASBB_NH_IN_Tree(Graph g1, Graph g2)
    {
    ...
    public Compact_Exact_GED_ASBB_NH_IN_Tree(Graph g1, Graph g2, long amount_RunTime) {
        comparator = new Path_Cost_Comparator();
        OPEN = new PriorityQueue<Path>(10, comparator);
