...
public class Main {
    ...
    public static void main(String[] args)
    {
        ...
        //Exact_GED_AStar_BB_NH_IN exact_GED = new Exact_GED_AStar_BB_NH_IN(g1,g2);
        Compact_Exact_GED_ASBB_NH_IN_Tree exact_GED = new Compact_Exact_GED_ASBB_NH_IN_Tree(g1,g2,amount_RunTime_S);
